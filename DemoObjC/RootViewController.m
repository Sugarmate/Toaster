...
- (void)showButtonTouchUpInside {
    ...
    [[[Toast alloc] initWithText:@"You can set duration. `ToasterDelay.Short` means 2 seconds.\n`ToasterDelay.Long` means 3.5 seconds." delay:0 duration:ToasterDelay.Long] show];
